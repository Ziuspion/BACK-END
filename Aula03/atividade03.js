...
console.log("o login do " + sislogin.tipo + " " + "é " + sislogin.login + " " + "e a senha é " + sislogin.senha + ", muito fraca por sinal.");
...
console.log("O professor " + professor.nome + " ministra a desciplina de " + professor.disciplina + " no turno da " + professor.turno);
